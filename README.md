...
Итоги курсового проекта:
1 Commit(были опечатки в коде) - r2(0.24569961344509228)
2 Commit(исправил опечатки в коде) - r2(0.7039456584475172)
3 Commit(подбор параметров функций подготовки данных) - r2(0.723073060357156)
